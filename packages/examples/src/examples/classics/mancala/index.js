    ...
    <div class="flex pt-8 justify-center">
        ...
        <div class="flex mb-6 flex-col justify-center">
            ...
            <div v-for="(stones, index) in board.slice(7, 13)" :key="index"
                ...
                class="flex flex-col items-center justify-center w-16 h-24 cursor-pointer transition-all duration-200 border-2 rounded-lg hover:bg-gray-100 text-lg font-bold"
                :class="[
