        ...
        <div class="flex flex-col space-y-4">
            ...
            <div class="text-center">
              ...
              <div class="flex justify-center mt-4">
                <div
                  ...
                  :key="index"
                  class="w-16 h-24 mx-1 rounded-lg flex items-center justify-center"
                  :class="[
          ...
          <div class="flex justify-center">
            <div
              ...
              class="w-24 h-36 mx-2 bg-green-500 text-white rounded-lg flex flex-col items-center justify-center cursor-pointer"
              :class="[
                        currentPlayer === 0 ? 'border-4 border-green-700' : 'opacity-70'
                    ]"
              v-motion
              :initial="{ rotate: 0, scale: 0.9 }"
              :hovered="{ rotate: Math.random() * 20 - 10, scale: 1 }"
