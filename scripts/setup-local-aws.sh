...
aws configure set aws_access_key_id kossabos --profile localstack
aws configure set aws_secret_access_key kossabos --profile localstack
...
echo "   Access Key: kossabos"
echo "   Secret Key: kossabos"
echo "   Region: us-east-2"
echo "   Endpoint: Use --endpoint-url http://localhost:4566"
echo ""
echo "🚀 Now you can run commands like:"
echo "   aws dynamodb scan --table-name kossabos-dev-use2-main --endpoint-url http://localhost:4566"
echo ""
echo "💡 To use this profile in your current shell session, run:"
echo "   export AWS_PROFILE=localstack"
echo ""
echo "🔄 Or use the --profile flag:"
echo "   aws dynamodb scan --table-name kossabos-dev-use2-main --endpoint-url http://localhost:4566 --profile localstack"